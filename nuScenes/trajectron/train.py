    ...
    for epoch in range(1, args.train_epochs + 1):
        ...
        for node_type, data_loader in train_data_loader.items():
            ...
            for batch in pbar:
                ...
                #print('Memory currently allocated: {:8.3f} MB'.format(memory_allocated / 2 ** 20))
                #print('Memory maximally allocated: {:8.3f} MB'.format(max_memory_allocated / 2 ** 20))
                #print('')
