...
Splitters = ['Random_split', 'Critical_split','Random_split_1','Random_split_2','Random_split_3']
Models = ['trajectron_salzmann_beta01', #beta = 0.01
          'trajectron_salzmann_beta0_1', #beta = 0.1
          'trajectron_salzmann_beta05', #beta = 0.5
          'trajectron_salzmann_beta1', #beta = 1
          'trajectron_salzmann_beta10', #beta = 10
          'trajectron_salzmann'] # original without smooth
