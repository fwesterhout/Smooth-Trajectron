...
sys.path.insert(0, os.path.dirname(__file__) + '/Trajectron-smooth/trajectron/')
import numpy as np
import pandas as pd
import torch
...
class trajectron_salzmann_beta0_1(model_template): #clas same name as filename
    ...
    def setup_method(self, seed = 0):
        ...
        hyperparams = {'batch_size': batch_size,
                       ...
                       'beta': 0.1} #!!! Todo: change beta value
